pipeline {
      ...
      environment {
	   ...
	   SPECTRAL_DSN = credentials("SPECTRAL_DSN2")
        }
       ...
       steps {   
         ...
         script {      
              try {
                ...
                sh './shiftleft code-scan -po -r -2003 -e b579409a-5b47-4fc9-9d6c-aacbe5313664 -s .'
       ...
       stage('ShiftLeft Container Image Scan') {    
            ...
            steps {
              ...
              try {
                    ...
                    sh './shiftleft image-scan -po -r -2002 -e b579409a-5b47-4fc9-9d6c-aacbe5313664 -i webapp.tar'
                   } catch (Exception e) {
